        ...
        for event in eventList:
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    ...
                    #新增修改坦克的坐标位置
                    if MainGame.PI_TANK.rect.left > 0:
                        MainGame.PI_TANK.rect.left -= MainGame.PI_TANK.speed

                elif event.key == pygame.K_RIGHT:
                    print("向右移动")
                    MainGame.PI_TANK.direction = 'R'
                    if MainGame.PI_TANK.rect.left < (MainGame.__SCREEN_WIDTH-MainGame.PI_TANK.rect.height):
                        MainGame.PI_TANK.rect.left += MainGame.PI_TANK.speed
                elif event.key == pygame.K_UP:
                    print("向上移动")
                    MainGame.PI_TANK.direction = 'U'
                    if MainGame.PI_TANK.rect.top > 0:
                        MainGame.PI_TANK.rect.top -= MainGame.PI_TANK.speed
                elif event.key == pygame.K_DOWN:
                    print("向下移动")
                    MainGame.PI_TANK.direction = 'D'
                    if MainGame.PI_TANK.rect.top < (MainGame.__SCREEN_HEIGHT-MainGame.PI_TANK.rect.height):
                        MainGame.PI_TANK.rect.top += MainGame.PI_TANK.speed
